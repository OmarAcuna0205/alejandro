    ...
    return (
        <div id="home" className="flex flex-col md:flex-row items-center justify-center gap-8 py-24 md:py-28 px-10 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col items-center gap-4 text-center">
                ...
                <motion.p className="text-muted text-xs md:text-sm tracking-widest uppercase"
                ...
                <motion.a href="#work" className="flex items-center gap-2 font-body text-xs tracking-[0.3em] uppercase px-8 py-3 border border-foreground/20 hover:bg-accent hover:text-black hover:border-accent transition-all duration-300 mt-2"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: 0.6 }}
                >Descarga mi CV<ArrowUpRightIcon size={16} />
                </motion.a>
